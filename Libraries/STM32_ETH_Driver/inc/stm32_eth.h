...
/** 
  * @brief  For MAV88E1111    PHY Specific Status Register Copper
  */ 
...
/** 
  * @brief  For MAV88E1111  
  */ 
#define PHY_Speed_Status            ((u16)0x4000)    /*!< Configured information of Speed: 100Mbps */
#define PHY_Duplex_Status           ((u16)0x2000)    /*!< Configured information of Duplex: Full-duplex */
